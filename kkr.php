...
<html lang="en" dir="ltr">
  ...
  <div class="kkr-container container">
    <div class="player-cards">
      <div class="player-img">
        <img src="players\KKR\DK.png"></div>
    ...
    <div class="player-cards">
      <div class="player-img">
        <img src="players\KKR\kul.png"></div>
    ...
    <div class="player-cards">
      <div class="player-img">
        <img src="players\KKR\rana.png"></div>
        <div class="player-details"><h1 class="player_names"><?php
    ...
    <div class="player-cards">
      <div class="player-img">
        <img src="players\KKR\Russell.png"></div>
        <div class="player-details"><h1 class="player_names"><?php
