...
<html lang="en" dir="ltr">
  ...
  <div class="rr-container container">
    <div class="player-cards">
      <div class="player-img">
        <img src="players\RR\smith.png"></div>
    ...
    <div class="player-cards">
      <div class="player-img">
        <img src="players\RR\sanju.png"></div>
    ...
    <div class="player-cards">
      <div class="player-img">
        <img src="players\RR\oshane.png"></div>
        <div class="player-details"><h1 class="player_names"><?php
    ...
    <div class="player-cards">
      <div class="player-img">
        <img src="players\RR\stokesy.png"></div>
        <div class="player-details"><h1 class="player_names"><?php
    ...
    <div class="player-cards">
      <div class="player-img">
        <img src="players\RR\unadkat.png"></div>
        <div class="player-details"><h1 class="player_names"><?php
