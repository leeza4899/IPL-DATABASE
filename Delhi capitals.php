...
<html lang="en" dir="ltr">
  ...
  <div class="delhi-container container">
    <div class="player-cards">
      <div class="player-img">
        <img src="players\DC\shreyas.png"></div>
    ...
    <div class="player-cards">
      <div class="player-img">
        <img src="players\DC\dhawan.png"></div>
    ...
    <div class="player-cards">
      <div class="player-img">
        <img src="players\DC\pant.png"></div>
        <div class="player-details"><h1 class="player_names"><?php
    ...
    <div class="player-cards">
      <div class="player-img">
        <img src="players\DC\rabada.png"></div>
        <div class="player-details"><h1 class="player_names"><?php
    ...
    <div class="player-cards">
      <div class="player-img">
        <img src="players\DC\ishant.png"></div>
        <div class="player-details"><h1 class="player_names"><?php
