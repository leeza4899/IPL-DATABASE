  ...
  <div class="mi-container container">
    <div class="player-cards">
      <div class="player-img">
        <img src="players\MI\rohit.png"></div>
    ...
    <div class="player-cards">
      <div class="player-img">
        <img src="players\MI\pndya.png"></div>
    ...
    <div class="player-cards">
      <div class="player-img">
        <img src="players\MI\polly.png"></div>
        <div class="player-details"><h1 class="player_names"><?php
    ...
    <div class="player-cards">
      <div class="player-img">
        <img src="players\MI\quinny.png"></div>
        <div class="player-details"><h1 class="player_names"><?php
    ...
    <div class="player-cards">
      <div class="player-img">
        <img src="players\MI\bumrah.png"></div>
        <div class="player-details"><h1 class="player_names"><?php
