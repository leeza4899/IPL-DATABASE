...
$sql1="SELECT * FROM batsmen where Player_name =  'Shreyas Iyer
';";
$sql2="SELECT * FROM batsmen where Player_name =  'Shikhar Dhawan';";
...
<html lang="en" dir="ltr">
  ...
  <div class="punjab-container container">
    <div class="player-cards">
      <div class="player-img">
        <img src="players\KXIP\KL.png"></div>
    ...
    <div class="player-cards">
      <div class="player-img">
        <img src="players\KXIP\gayle.png"></div>
    ...
    <div class="player-cards">
      <div class="player-img">
        <img src="players\KXIP\agarwal.png"></div>
        <div class="player-details"><h1 class="player_names"><?php
    ...
    <div class="player-cards">
      <div class="player-img">
        <img src="players\KXIP\rujeeb.png"></div>
        <div class="player-details"><h1 class="player_names"><?php
         echo $row4["Player_name"];
        echo ' ('.$row4["jersey_number"].')'?>
         <br>
         <?php echo $row4["Nationality"]?></h1>
         <h3>Matches:<?php echo " ".$row4["total_matches"]?>
         </h3><h3>Runs:
         <?php echo $row4["runs"]?>
         </h3>
         <h3>50's:
    ...
    <div class="player-cards">
      <div class="player-img">
        <img src="players\KXIP\shami.png"></div>
        <div class="player-details"><h1 class="player_names"><?php
