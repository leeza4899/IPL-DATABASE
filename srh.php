  ...
  <div class="srh-container container">
    <div class="player-cards">
      <div class="player-img">
        <img src="players\SRH\bhuv.png"></div>
    ...
    <div class="player-cards">
      <div class="player-img">
        <img src="players\SRH\shankar.png"></div>
    ...
    <div class="player-cards">
      <div class="player-img">
        <img src="players\SRH\warner.png"></div>
        <div class="player-details"><h1 class="player_names"><?php
    ...
    <div class="player-cards">
      <div class="player-img">
        <img src="players\SRH\manish.png"></div>
        <div class="player-details"><h1 class="player_names"><?php
    ...
    <div class="player-cards">
      <div class="player-img">
        <img src="players\SRH\kane.png"></div>
        <div class="player-details"><h1 class="player_names"><?php
